...
public class Main {
    ...
    // Constantes para categorías y secciones
    ...
    // Nombres de categorías y secciones
    ...
    // Matrices para almacenar la información por categoría y sección
    private static int[] categoriaProducto = new int[MAX_PRODUCTOS]; // Categoría de cada producto
    private static int[] seccionProducto = new int[MAX_PRODUCTOS]; // Sección de cada producto

    // Matriz para almacenar índices de productos por categoría y sección
    // [categoría][sección][índice del producto en esa combinación]
    private static int[][][] productosPorCategoriaSeccion = new int[MAX_CATEGORIAS][MAX_SECCIONES][MAX_PRODUCTOS_POR_SECCION];

    // Contador de productos por categoría y sección
    ...
    private static void addProduct() {
        ...
        // Seleccionar sección para el producto
        int seccion = seleccionarSeccion();

        // Verificar si hay espacio en la matriz de la categoría y sección seleccionada
        ...
        // Guardar la categoría y sección del producto
        categoriaProducto[cantidadProductos] = categoria;
        seccionProducto[cantidadProductos] = seccion;

        // Agregar el índice del producto a la matriz por categoría y sección
    ...
    /**
     * Muestra las secciones disponibles y solicita al usuario seleccionar una
     */
    ...
    /**
     * Genera un reporte del inventario organizado por categoría y sección
     */
    private static void generateReportByCategory() {
        ...
        for (int cat = 0; cat < MAX_CATEGORIAS; cat++) {
            ...
            // Recorrer cada sección de esta categoría
            for (int sec = 0; sec < MAX_SECCIONES; sec++) {
                ...
                if (numProductos > 0) {
                    ...
                    // Recorrer productos de esta sección
